...
import { PROFILE_AVATARS, ProfileAvatar } from "./profile-avatar";
...
describe("profile avatars", () => {
  ...
  it("uses a current portrait for unknown IDs", () => {
    expect(renderToStaticMarkup(<ProfileAvatar id="../../missing" />)).toBe(
      renderToStaticMarkup(<ProfileAvatar id="line-curls-animated" />),
    );
  });
});
